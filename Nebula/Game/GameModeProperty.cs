...
public class GameModeProperty
{
    ...
    public Action OnCountFinished { private set; get; }

    public GameModeProperty(Module.CustomGameMode RelatedMode, IntRange ValidPlayers, bool RequireImpostors, bool RequireGhosts, bool CountTasks, Action? RequireStartCountDown, Roles.Role DefaultCrewmate, Roles.Role DefaultImpostor, Module.CustomOptionTab Tabs)
    ...
    public GameModeProperty(Module.CustomGameMode RelatedMode, int MinPlayers, bool RequireImpostors, bool RequireGhosts, bool CountTasks, Action? RequireStartCountDown, Roles.Role DefaultCrewmate, Roles.Role DefaultImpostor, Module.CustomOptionTab Tabs)
    {
    ...
    public static Dictionary<Module.CustomGameMode, GameModeProperty> Properties = new Dictionary<Module.CustomGameMode, GameModeProperty>();

    public static GameModeProperty StandardMode;
    public static GameModeProperty FreePlayMode;
    public static GameModeProperty StandardHnSMode;
    public static GameModeProperty FreePlayHnSMode;
    public static GameModeProperty BattleMode;
    public static GameModeProperty VirusCrisisMode;
    public static GameModeProperty CompeteMode;
    ...
    public static GameModeProperty GetProperty(Module.CustomGameMode gameMode)
    {
