...
{
    private static HashSet<EffectCircle> allCircles = new HashSet<EffectCircle>();
    ...
    private static SpriteLoader circleSprite = new SpriteLoader("Nebula.Resources.EffectCircle.png", 250f);
    private static SpriteLoader circleInnerSprite = new SpriteLoader("Nebula.Resources.EffectCircleInner.png", 100f);
    private float timer;
