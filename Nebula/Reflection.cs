...
public static class Reflection
{
    ...
    public static unsafe object CallBase<T, TDelegate>(this Object obj, string name, params object[] args)
    where T : Object
    ...
    public static unsafe void CallBase<T>(this Object obj, string name)
        where T : Object
    {
        IntPtr klass = Il2CppClassPointerStore<T>.NativeClassPtr;
