...
{
    public static Color RoleColor = new Color(185f / 255f, 152f / 255f, 197f / 255f);

    public CustomOption spawnImmoralistOption;
    private CustomOption occupyDoubleRoleCountOption;
    public CustomOption spectreTaskOption;
    public CustomOption numOfTheFriedRequireToWinOption;
    private CustomOption clarifyChargeOption;
    private CustomOption clarifyDurationOption;
    private CustomOption clarifyCoolDownOption;
    public CustomOption canTakeOverSabotageWinOption;
    public CustomOption canTakeOverTaskWinOption;
    public CustomOption canFixEmergencySabotageOption;
    private CustomOption ventCoolDownOption;
    private CustomOption ventDurationOption;

    private List<Arrow?> impostorArrows;
    private List<Arrow?> jackalArrows;
    private List<Arrow?> pavlovArrows;
    private List<Arrow?> moriartyArrows;
    private List<Arrow?> sheriffArrows;
    private List<Arrow?> werewolfArrows;
    private List<Arrow?> challengerArrows;
    private List<Arrow?> oracleArrows;
    private List<Arrow?> santaArrows;
    private int clarifyChargeId;
    ...
    {
        private Dictionary<byte, Tuple<List<CustomTaskData>, CustomOption>> TaskDic = new();
        ...
        public Tuple<List<CustomTaskData>, CustomOption> GetSetting(byte mapId)
        {
    ...
    public override void ButtonInitialize(HudManager __instance)
    {
        ...
        spectreButton = new CustomButton(
            () =>
            {
                RPCEventInvoker.EmitAttributeFactor(PlayerControl.LocalPlayer, new PlayerAttributeFactor(Game.PlayerAttribute.Invisible, clarifyDurationOption.getFloat(), 0, false));
    ...
    public override void LoadOptionData()
    {
        ...
        spectreTaskOption = CreateOption(Color.white, "spectreTask", new string[] { "option.switch.off", "role.spectre.spectreTask.eatTheFried", "role.spectre.spectreTask.deliveryRancor" }, "role.spectre.spectreTask.eatTheFried");
    ...
    private SpriteLoader arrowSprite = new SpriteLoader("role.spectre.arrow");
    ...
    : base("Spectre", "spectre", RoleColor, RoleCategory.Neutral, Side.Spectre, Side.Spectre,
         ...
         new HashSet<EndCondition>() { EndCondition.SpectreWin },
