...
{
    private static PlayerControl? SearchPlayer(float distance, float angle)
    {
    ...
    public static IEnumerator CoOrient(LightSource light, float preDuration, float duration, Action<float> inSerchFunc, Action finalFunc)
    {
        float t;
    ...
    public static IEnumerator CoOrient(LightSource light, float preDuration, float duration, Action<PlayerControl?> nearbyPlayerFunc, Action<PlayerControl?> finalPlayerFunc)
