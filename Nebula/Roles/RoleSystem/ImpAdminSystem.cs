...
{
    private static MapCountOverlay? jailerCountOverlay = null;

    public static bool IsJailerCountOverlay(MapCountOverlay overlay) => overlay == jailerCountOverlay;

    private static CustomButton adminButton = null;

    public static void ButtonInitialize(HudManager __instance, bool canMoveWithLookingMap, bool ignoreComm, bool canIdentifyImpostors)
    {
