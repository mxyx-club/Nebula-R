...
{
    private List<PlayerControl> semiActivePlayers;
    private List<PlayerControl> activePlayers;
    private List<byte> bytePlayers;
...
{
    new Tuple<string, Action>("role.banshee.help.weepRange",()=>{new EffectCircle(PlayerControl.LocalPlayer.gameObject.transform.position, Palette.White, 1f,16f,false,Palette.ImpostorRed);})
};
