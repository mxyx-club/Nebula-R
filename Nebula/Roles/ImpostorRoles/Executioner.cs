...
public class Executioner : Role
{
   ...
   {
        new Tuple<string, Action>("role.executioner.help.killRange",()=>{new EffectCircle(PlayerControl.LocalPlayer.gameObject.transform.position, Palette.White, 5.5f,16f,false,Palette.ImpostorRed);})
   };
